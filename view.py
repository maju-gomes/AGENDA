...
class ClienteView:
    ...
    def atualizar_cliente(id, nome, email, fone, senha):
        cliente = Cliente(id, email, fone, senha)
    ...
    def criar_cliente_admin():
        for cliente in ClienteView.listar_cliente():
            if cliente.get_email() == "admin":
                # aqui deve ter algo de erraado... o cadastro de admins 
                return ClienteView.inserir_cliente("admin", "admin", "fone", "1234")
